...
export const CruisePage = () => {
  ...
  const engine2FuelUsedDisplay = engine1FuelUsedDisplay;
  ...
  const engine2FuelFlowDisplay = engine1FuelFlowDisplay;
  const engine3FuelFlowDisplay = fuelForDisplay(engine2FuelFlow, unit);
  const engine4FuelFlowDisplay = engine3FuelFlowDisplay;
